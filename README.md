...
I build practical web experiences, brand systems, and small business tooling with a focus on clean interfaces, responsive layouts, and deployment-ready details.

Right now I am working across front-end development, business website builds, visual QA, brand identity systems, and 3D/Cinema 4D material workflows.
...
Tech and workflow: React, Vite, custom CSS animation, Cloudflare Pages, Playwright visual checks, brand asset organization, responsive layout design.

### Proweaver Website Technology Audit
...
Focus areas: WordPress, jQuery, animation libraries, carousels, tracking pixels, Cloudflare behavior, UI/UX analysis, technical documentation.

### Cinema 4D / Redshift Material Workflows
A starter material library and scene workflow using CC0 PBR texture sets for Redshift and Cinema 4D experiments.

Focus areas: PBR map wiring, material setup, 3D scene composition, chrome/neon styling, dynamic text, and render-ready asset organization.

### Web Resume
A GitHub Pages resume project based on a Jekyll template.

Repo: [zohbot/web-resume](https://github.com/zohbot/web-resume)
...
I like projects that turn rough ideas into something structured and usable: a brand system that can actually ship, a website that feels clean on both desktop and mobile, or a technical audit that makes a complex page easier to understand.
