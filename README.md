...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Planning and staging a Raspberry Pi 3B to Raspberry Pi 5 migration by preparing the Pi 5 first, validating services, and cutting over only after the replacement environment is ready.</p>
      <p><strong>Focus areas:</strong> staged migration, production replacement planning, service validation, rollback-aware thinking.</p>
    </td>
    <td width="50%" valign="top">
      <h3>Monitoring Stack</h3>
      <p>Running Node Exporter on the Pi and using Grafana from an Oracle VM on the desktop to monitor system health and infrastructure behavior.</p>
      <p><strong>Focus areas:</strong> metrics collection, dashboards, host monitoring, Grafana visualization, Prometheus-style observability.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>Docker Container Management</h3>
      <p>Setting up Portainer to manage Docker containers with a cleaner interface for container lifecycle work and local service administration.</p>
